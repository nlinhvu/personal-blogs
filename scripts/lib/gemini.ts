...
export function buildSystemInstruction(
  ...
  return [
    ...
    "4. TERMINOLOGY. Keep every term of the trade in English. A software",
    "   engineer reading this already knows these words in English, will meet",
    "   them again in English documentation, and will search for them in",
    "   English. Translating one costs the reader the word they would look up.",
    "     record, signature, key, fingerprint, hash, checksum, registrar,",
    "     registry, resolver, zone, cache, algorithm, digest, flags, protocol,",
    "     throughput, latency, deadlock, garbage collection, virtual thread",
    "   That list is examples, not limits: the rule covers every term like",
    "   them, including ones not listed here.",
    "   Two terms can look alike and be different things — registrar is the",
    "   company a domain is bought from, registry is the operator of the TLD.",
